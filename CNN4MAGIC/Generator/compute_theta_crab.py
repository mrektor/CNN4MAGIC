...
weights_path = '/home/emariott/software_magic/output_data/snapshots/SEDenseNet121_position_noclean_Gold_2019-02-25_01-37-25-10.h5'
...
separation = separation_gammaness
# %%
...
for gammaness in tqdm(gammaness_list):
    ...
    plt.savefig(
        f'/home/emariott/software_magic/output_data/pictures/crab_significance_2/theta2_crab_{gammaness}_zoom.png')
    plt.savefig(
        f'/home/emariott/software_magic/output_data/pictures/crab_significance_2/theta2_crab_{gammaness}_zoom.pdf')

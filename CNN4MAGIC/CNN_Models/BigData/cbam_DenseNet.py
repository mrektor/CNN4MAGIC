...
def CBAMDenseNetImageNet121(input_shape=None,
                            bottleneck=True,
                            reduction=0.5,
                            dropout_rate=0.0,
                            weight_decay=1e-4,
                            ...
                            classes=1000,
                            activation='softmax'):
    return CBAMDenseNet(input_shape, depth=121, nb_dense_block=4, growth_rate=32, nb_filter=64,
...
def CBAMDenseNetImageNet169(input_shape=None,
                            bottleneck=True,
                            reduction=0.5,
                            dropout_rate=0.0,
                            weight_decay=1e-4,
                            ...
                            classes=1000,
                            activation='softmax'):
    return CBAMDenseNet(input_shape, depth=169, nb_dense_block=4, growth_rate=32, nb_filter=64,
...
def CBAMDenseNetImageNet201(input_shape=None,
                            bottleneck=True,
                            reduction=0.5,
                            dropout_rate=0.0,
                            weight_decay=1e-4,
                            ...
                            classes=1000,
                            activation='softmax'):
    return CBAMDenseNet(input_shape, depth=201, nb_dense_block=4, growth_rate=32, nb_filter=64,
...
def CBAMDenseNetImageNet264(input_shape=None,
                            bottleneck=True,
                            reduction=0.5,
                            dropout_rate=0.0,
                            weight_decay=1e-4,
...
def CBAMDenseNetImageNet161(input_shape=None,
                            bottleneck=True,
                            reduction=0.5,
                            dropout_rate=0.0,
                            weight_decay=1e-4,
                            ...
                            classes=1000,
                            activation='softmax'):
    return CBAMDenseNet(input_shape, depth=161, nb_dense_block=4, growth_rate=48, nb_filter=96,

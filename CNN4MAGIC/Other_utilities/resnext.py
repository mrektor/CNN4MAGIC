...
def ResNext(input_shape=None, depth=29, cardinality=8, width=64, weight_decay=5e-4,
    ...
    input_shape = input_tensor.shape#_obtain_input_shape(input_shape,
                                      # default_size=32,
                                      # min_size=8,
...
def __initial_conv_block_imagenet(input, weight_decay=5e-4):
    ...
    x = Conv2D(64, (7, 7), padding='same', use_bias=False, kernel_initializer='he_normal',
               kernel_regularizer=l2(weight_decay), strides=(2, 2))(x)
    x = BatchNormalization(axis=channel_axis)(x)
    x = Activation('relu')(x)
